...
by reusing the np.random.default_rng(printer_id) pattern from backend.simulator.generate.
"""
...
from backend.simulator.core.simulator import PrinterStepper, run_printer
